        ...
        <div className="overlay-content content grid">
          ...
          <div className="about-contact">
            ...
            <ul className="contact-list">
              <li className="contact"><a href="mailto:annabrisland@gmail.com">Email</a></li>
              <li className="contact"><a href="https://github.com/annabrisland" target="_blank">GitHub</a></li>
              <li className="contact"><a href="www.linkedin.com/in/anna-brisland" target="_blank">Linkedin</a></li>
            </ul>
          </div>
        </div>
      </div>
