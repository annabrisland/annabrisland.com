  ...
  return (
    ...
    <div className="overlay" id="about-overlay">
        ...
        <div className="overlay-content">
            ...
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspisse dictum ex non purus cursus tempor. 
            </div>
    ...
    <section className="content">
        <div className="grid">
            <div className="card-1 card" id="ubc-botany" onClick={() => {
          history.push("ubcbotany");
            ...
            <div className="card-2 card" id="labby" onClick={() => {
          history.push("labby");
        }}>
                <div className="card-info">
                    <div className="card-head">
        ...
        <div className="grid">
            <div className="card-3 card" id="umami" onClick={() => {
          history.push("umami");
        }}>
                <div className="card-info">
                    <div className="card-head">
            ...
            <div className="card-4 card" id="kudocoin" onClick={() => {
    ...
    <footer>
        <div className="grid">
            ...
            <div id="contact-items">
                <a href="https://github.com/annabrisland" target="_blank"><button className="contact-link"><img src="./assets/images/github.png" alt="GitHub Logo"/></button></a>
                <a href="www.linkedin.com/in/anna-brisland"
                target="_blank"><button className="contact-link"><img src="./assets/images/linkedin.png" alt="LinkedIn Logo"/></button></a>
                <a href="mailto:annabrisland@gmail.com"><button className="contact-link"><img src="./assets/images/email.png" alt="Email"/></button></a>
            </div>
        </div>
    </footer>
</div>
